...
const LINKS = [
  { href: "/", label: "Humanizer", icon: Sparkles },
    ...
    <aside className="fixed left-0 top-0 h-full w-16 md:w-48 glass-panel border-r border-white/5 flex flex-col py-6 z-50">
      <div className="px-4 mb-8 flex items-center gap-3">
        ...
        <span className="hidden md:block text-sm font-bold text-white tracking-tight">
          <span className="bg-clip-text text-transparent bg-gradient-to-r from-white to-neutral-400">AI Evasion</span>
          <br />
          <span className="text-violet-400 font-medium text-xs">Engine</span>
        </span>
      </div>
